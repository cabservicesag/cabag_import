 ...
 */
class HtmlspecialcharsDecode implements FieldprocInterface {
	...
	*/
	function main($stackPartConf=false, $object_handler) {		
		...
		$object_handler->currentFieldValue = htmlspecialchars_decode($object_handler->currentFieldValue, ENT_NOQUOTES);
